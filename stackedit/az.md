...
* **Action**: Connected to the file server and saw evidence of a ransomware attack. Immediately powered off the file server
* **Result**: 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTk2MDAyOTE2LDE4Njc1MTEzNzYsLTUxMj
