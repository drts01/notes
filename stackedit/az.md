...
* **Action**: Started bi-weekly trainings around Git, Python, Saltstack
* **Result**:  More engineers that were more efficent by leveraging development best practices.
* 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzcwMTYzMjQxLDEyNjk0MDQzODAsMTUwNT
